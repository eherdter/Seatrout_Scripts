...
### _4. Make age-length keys (ALKs)_
...
use a function to adjust the geom_crossbar call to ggplot
```{r warning = FALSE}
...
### _6. Among group statistical comparisons of ALKs_
